# Completed Prompt - Template 1: api-controller-category
...
CategoryController in PromptEvaluation.Api.Controllers for route "api/categories".

Context:
- Entity identifier type: int
- Read authorization: Anonymous
- Create/update/delete authorization: Admin
- Business logic belongs in ICategoryService, not the controller.
...
- Use [ApiController], attribute routing, constructor injection, async/await,
  CancellationToken, ActionResult, and ILogger<CategoryController>.
