# Completed Prompt - Template 2: crud-service-category
...
```text
Act as a senior .NET backend developer. Implement CategoryService for
ICategoryService using EvaluationDbContext and EF Core.

Inputs:
- Identifier: int
- Mutable properties: Name, Description, IsActive
- Uniqueness/business rule: Name must be case-insensitively unique; a referenced category cannot be deleted
