# Completed Prompt - Template 10: integration-tests-category
...
Seed data: one referenced Category, one unreferenced Category, one Event, and deterministic duplicate/not-found identifiers
External services to replace: authentication handler; no external network calls
